...
// Map is like a Go map but is safe for concurrent use
...
type Map[K, V comparable] struct {
	...
	// expunged is an arbitrary value that marks entries which have been deleted
	// from the dirty map.
	expunged V
}
...
// the entry unchanged.
func (e *entry[T]) tryCompareAndSwap(old, new T, expunged *T) bool {
	p := e.p.Load()
